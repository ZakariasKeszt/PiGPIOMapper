...
int rio_set_out_state(rio_handle_t* handle, rp1_rio_out_state_t state){
    ...
    *(volatile uint32_t*)(handle->rio_out + RP1_SET_OFFSET) = state;
...
int rio_clr_out_state(rio_handle_t* handle, rp1_rio_out_state_t state){
    uint32_t select = rp1_rio_out_state_lookup[state];
    *(volatile uint32_t*)(handle->rio_out + RP1_CLR_OFFSET) = state;

    return 0;
}

int rio_xor_out_state(gpio_handle_t* handle, rp1_rio_out_state_t state){
    uint32_t select = rp1_rio_out_state_lookup[state];
    *(volatile uint32_t*)(handle->rio_out + RP1_XOR_OFFSET) = state;
...
int rio_set_oe_state(rio_handle_t* handle, rp1_rio_oe_enable_t state){
    ...
    *(volatile uint32_t*)(handle->rio_oe + RP1_SET_OFFSET) = state;
...
int rio_clr_oe_state(rio_handle_t* handle, rp1_rio_oe_enable_t state){
    uint32_t select = rp1_rio_oe_enable_lookup[state];
    *(volatile uint32_t*)(handle->rio_oe + RP1_CLR_OFFSET) = state;

    return 0;
}

int rio_xor_oe_state(gpio_handle_t* handle, rp1_rio_oe_enable_t state){
    uint32_t select = rp1_rio_oe_enable_lookup[state];
    *(volatile uint32_t*)(handle->rio_oe + RP1_XOR_OFFSET) = state;
...
int rio_set_in_state(rio_handle_t* handle, rp1_rio_in_enable_t state){
    ...
    *(volatile uint32_t*)(handle->rio_in + RP1_SET_OFFSET) = state;
...
int rio_clr_in_state(rio_handle_t* handle, rp1_rio_in_enable_t state){
    uint32_t select = rp1_rio_in_enable_lookup[state];
    *(volatile uint32_t*)(handle->rio_in + RP1_CLR_OFFSET) = state;

    return 0;
}

int rio_xor_in_state(gpio_handle_t* handle, rp1_rio_in_enable_t state){
    uint32_t select = rp1_rio_in_enable_lookup[state];
    *(volatile uint32_t*)(handle->rio_in + RP1_XOR_OFFSET) = state;
